...
def analyze_udp_header(data_recv):
    ...
    print "_____________UDP HEADER______________"
...
def analyze_tcp_header(data_recv):
    ...
    print "_________________TCP HEADER________________"
    print "Source: %hu " % src_port
    print "Destination: %hu " % dst_port
    print "Seq: %u " % seq_num
    print "Ack :%u " % ack_num
...
def analyze_ip_header(data_recv):
    ...
    print "_______________IP HEADER________________"
...
def analyze_ether_header(data_recv):
    ...
    print "_____________ETHERNET HEADER______________"
